...
var person_Name = "Ali Haider Noorani"; //Stores person name
console.log(person_Name.toUpperCase()); //Shows name in uppercase
console.log(person_Name.toLowerCase()); //Shows name in lowercase
console.log(person_Name.replace(/\b\w/g, function (word) { return word.toUpperCase(); })); //Shows name in titlecase
console.log("\n");
//Ali Haider Noorani
//06/03/2024
...
var favouriteNumber = 5; //Stores number in variable
