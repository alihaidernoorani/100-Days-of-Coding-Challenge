...
var guestList = ["Albert Einstein", "Allama Iqbal", "Muhammad Ali Jinnah"]; //Stores guests
for (var i = 0; i < guestList.length; i++) {
    console.log("Dear ".concat(guestList[i], ", I would like to invite you for dinner")); //Prints initation for each guest
}
